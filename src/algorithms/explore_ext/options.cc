...
namespace tchecker_ext {
  ...
  namespace explore_ext {
    ...
    enum tchecker_ext::explore_ext::options_t::output_format_t options_t::output_format() const
    {
      return _output_format;
    }

    tchecker_ext::explore_ext::options_t::accepting_labels_range_t options_t::accepting_labels() const
    {
      return tchecker::make_range(_accepting_labels);
    }
    
    
    enum tchecker_ext::explore_ext::options_t::explored_model_t options_t::explored_model() const
    {
    ...
    enum tchecker_ext::explore_ext::options_t::search_order_t options_t::search_order() const
    {
    ...
    {
      if (value == "dot")
        _output_format = tchecker_ext::explore_ext::options_t::DOT;
      else if (value == "raw")
        _output_format = tchecker_ext::explore_ext::options_t::RAW;
      else
    ...
    {
      if (value == "fsm")
        _explored_model = tchecker_ext::explore_ext::options_t::FSM;
      else if (value == "ta")
        _explored_model = tchecker_ext::explore_ext::options_t::TA;
      else {
        boost::char_separator<char> sep(":");
        boost::tokenizer<boost::char_separator<char> > tokenizer(value, sep);
    ...
    void options_t::set_explored_model_zg(std::string const & semantics, std::string const & extrapolation, tchecker::log_t & log)
    {
      if (semantics == "elapsed") {
        if (extrapolation == "NOextra")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_NOEXTRA;
        else if (extrapolation == "extraMg")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_EXTRAM_G;
        else if (extrapolation == "extraMl")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_EXTRAM_L;
        else if (extrapolation == "extraM+g")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_EXTRAM_PLUS_G;
        else if (extrapolation == "extraM+l")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_EXTRAM_PLUS_L;
        else if (extrapolation == "extraLUg")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_EXTRALU_G;
        else if (extrapolation == "extraLUl")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_EXTRALU_L;
        else if (extrapolation == "extraLU+g")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_EXTRALU_PLUS_G;
        else if (extrapolation == "extraLU+l")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_ELAPSED_EXTRALU_PLUS_L;
        else
          log.error("Unknown extrapolation: " + extrapolation + " for command line parameter -m");
      }
      else if (semantics == "non-elapsed") {
        if (extrapolation == "NOextra")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_NOEXTRA;
        else if (extrapolation == "extraMg")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_EXTRAM_G;
        else if (extrapolation == "extraMl")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_EXTRAM_L;
        else if (extrapolation == "extraM+g")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_EXTRAM_PLUS_G;
        else if (extrapolation == "extraM+l")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_EXTRAM_PLUS_L;
        else if (extrapolation == "extraLUg")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_EXTRALU_G;
        else if (extrapolation == "extraLUl")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_EXTRALU_L;
        else if (extrapolation == "extraLU+g")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_EXTRALU_PLUS_G;
        else if (extrapolation == "extraLU+l")
          _explored_model = tchecker_ext::explore_ext::options_t::ZG_NON_ELAPSED_EXTRALU_PLUS_L;
        else
          log.error("Unknown extrapolation: " + extrapolation + " for command line parameter -m");
      }
      else
    ...
    {
      if (semantics == "elapsed")
        _explored_model = tchecker_ext::explore_ext::options_t::ASYNC_ZG_ELAPSED_EXTRALU_PLUS_L;
      else if (semantics == "non-elapsed")
        _explored_model = tchecker_ext::explore_ext::options_t::ASYNC_ZG_NON_ELAPSED_EXTRALU_PLUS_L;
      else
        log.error("Unknown semantics: " + semantics + " for command line parameter -m");
    }
    ...
    {
      if (value == "bfs")
        _search_order = tchecker_ext::explore_ext::options_t::BFS;
      else if (value == "dfs")
        _search_order = tchecker_ext::explore_ext::options_t::DFS;
      else
